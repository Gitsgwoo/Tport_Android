...
data class Path2 (
    ...
    val fare: String = "", //요금
    @ColumnInfo
    val naverTravelTime: String = "", //기존 걸리는 시간
    @ColumnInfo
    val tportTravelTime: String = "", //보정 후 걸리는 시간
    @ColumnInfo
    val naverArrivalTime: String = "", //기존 도착 시간
    @ColumnInfo
    val tportArrivalTime: String = "", //보정 후 도착 시간
    @ColumnInfo
